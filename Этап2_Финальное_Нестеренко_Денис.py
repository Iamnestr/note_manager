# 1. add_titles_loop.py: Цикл для добавления заголовков (Сделал два варианта с разными кодами)
# Функциональность:
...
# (Во втором варианте добавил возможность пользователю вводить новый статус в текстовом формате)
# Функциональность:
...
# (Добавил поддержку нечувствительного к регистру поиска,
# а также возможность удалить сразу несколько заметок)
# Функциональность:
